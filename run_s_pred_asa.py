...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='S-Pred for accessible surface area prediction: input msa and output asa value (.json)')
    parser.add_argument('-i', '--input_path', type=str, default='examples/s_pred_asa.a3m',
